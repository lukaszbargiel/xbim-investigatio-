...
using XbimFloorPlanGenerator.Data.Repositories;
using XbimFloorPlanGenerator.Services;
using XbimFloorPlanGenerator.Services.DTO.Mapper;
using XbimFloorPlanGenerator.Services.Interfaces;

namespace XbimFloorPlanGenerator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(options => options.UseSqlServer(connection, s => s.MigrationsAssembly("XbimFloorPlanGenerator")));

            services.AddScoped<IIfcFileRepository, IfcFileRepository>();
            ...
            services.AddScoped<IIfcStairService, IfcStairService>();
